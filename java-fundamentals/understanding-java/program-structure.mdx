...
The filename of every file in a Java program must be the name of the **single** public [class](notion://www.notion.so/basic-java/classes), [interface](notion://www.notion.so/advanced/java/abstract-classes-and-interfaces#interfaces), or [enum](notion://www.notion.so/advanced/coming-soon).
...
<Quiz>
<QuizQuestion>Which code segment is correct?</QuizQuestion>
<QuizOption key="1">
