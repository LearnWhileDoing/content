...
This grouping of information is known as encapsulation, and is one of the primary laws of OOP. This principle also applies to [instance variables](notion://www.notion.so/basic-java/classes#instance-variables).
...
<Bookmark url="https://www.w3schools.com/java/java_methods.asp">
Java Methods
</Bookmark>

<Bookmark url="https://www.programiz.com/java-programming/methods">
