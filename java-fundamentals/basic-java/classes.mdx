...
This line is called the *class header*, and it is used to tell Java what your class is called, as well as which class you plan on [inheriting and extending](notion://www.notion.so/#whats-covered-in-this-course) and/or which interface you plan on [implementing](notion://www.notion.so/advanced/coming-soon).
...
<Video url="https://youtu.be/vjjjGkXpX_I">
Java Classes - How To Use Classes in Java
</Video>

<Bookmark url="https://www.w3schools.com/java/java_classes.asp">
