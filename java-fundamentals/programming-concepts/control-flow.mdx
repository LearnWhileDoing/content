...
The above is an example of an `if` statement code block. It will only run if the given [condition](programming-concepts/booleans) is met. In this case, if `shouldMove` is `true`, then we call `move()` on the robot object.
...
<Bookmark url="https://www.w3schools.com/java/java_conditions.asp">
Java If ... Else
</Bookmark>

<Bookmark url="https://www.w3schools.com/java/java_switch.asp">
Java Switch
</Bookmark>
