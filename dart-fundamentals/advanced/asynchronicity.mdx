...
`Future`s provide special callbacks for dealing with errors. To go into more detail with this, check out the following resource.

<Bookmark url="https://dart.dev/guides/libraries/futures-error-handling">
