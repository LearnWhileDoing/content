...
Dart uses a concept called *operators* to perform *operations* on values. There are different types of operators used for performing different operations, but in this lesson we will look at the 7 main arithmetic operators.
