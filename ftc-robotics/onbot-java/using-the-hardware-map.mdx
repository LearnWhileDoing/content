In a [previous lesson](robot-setup/hardware-mapping), you learned how to set up a hardware map configuration for your robot. Now, we will learn how to reference that hardware map in your code.
