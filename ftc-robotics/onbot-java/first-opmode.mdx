...
Hopefully it wasn't _too_ complicated and you understood what you have learned. If not, feel free to [reach out for help](intro/get-help).
...
Psst! If you are looking for some sample OpModes, they are available in the [project folder](programming-setup/project-folder). In Android Studio, they are available under the "FtcRobotController" module in the package `org.firstinspires.ftc.robotcontroller.external.samples`
