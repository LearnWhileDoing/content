...
This course builds off of basic Java knowledge. It is recommended that you complete the [Java Fundamentals](https://app.learnwhiledoing.org/course/java-fundamentals) basic module before you begin this course. If you are confident in your Java skills, then feel free to skip this prerequisite.
