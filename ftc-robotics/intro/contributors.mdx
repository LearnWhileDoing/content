...
This course is open-source and available on GitHub at [https://github.com/LearnWhileDoing/content](https://github.com/LearnWhileDoing/content). The course is licensed under the copy-left GNU General Public License v3.0 (GNU GPLv3).
